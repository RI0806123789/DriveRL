...
#: ウォームスタート直後の探索ノイズ。**教師を再現できる精度に見合った幅にすること。**
#: 回帰後の誤差は RMSE 0.05 前後なのに、既定の 0.6 のままだとステアに乗って車線を外れ、
#: 衝突の罰（-100）で「止まる方が得」へ戻る（実測: 60 秒で 0.6 は衝突 1 回・報酬 +61.2、
#: 0.15 は衝突 0 回・報酬 +138.4）
WARMSTART_STD = 0.15
